...
1. [**Problem definition**](https://https://github.com/Noodle96/machine-learning/01-getting-ready-to-machine-learning/6-step-framework-for-approaching-machine-learning-projects.md#1-problem-definitionrephrase-your-business-problem-as-a-machine-learning-problem) — What business problem are we trying to solve? How can it be phrased as a machine learning problem?
